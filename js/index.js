import{g as v,K as u,e as m,i as f,u as d,c as p,f as _,h as w,m as h,j as y,k as b,l as L,p as k,n as E,a as j,b as F,d as I,s as q}from"../assets/searchProduct-Yfm9SKHu.js";import{g,a as O,c as C}from"../assets/vendor-CWWLBHNg.js";function N(a){const s=document.querySelector(".js-main-swiper-stock"),e=document.querySelector(".js-main-swiper-seasonal"),r=document.querySelector(".js-main-swiper-present"),c=["Stock","Seasonal","Present"],n=[s,e,r],t=g(a);for(let o=0;o<c.length;o++){const i=c[o],l=n[o];v(t,i,l)}}function A(){const a=document.querySelector(".js-preloader");s();function s(){if(!localStorage.getItem("is-visit")){e();return}a.classList.add("preloader_hidden"),document.body.classList.remove("to-freeze")}function e(){a.classList.add("preloader_visible"),document.body.classList.add("to-freeze"),setTimeout(()=>{a.classList.add("preloader_hidden"),document.body.classList.remove("to-freeze"),localStorage.setItem("is-visit","true")},4e3)}}function T(a){const s=document.querySelector(".js-main-swiper-forum"),e=a.map(({title:r,description:c,img:{png:n,webp:t}})=>`
