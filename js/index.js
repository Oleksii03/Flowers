import{S as f,P as B,A as I,G as H,N as M,g as L,a as k,c as S,i as A}from"../assets/vendor-ANkZcBYd.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))i(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function r(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(t){if(t.ep)return;t.ep=!0;const s=r(t);fetch(t.href,s)}})();function F(){const e=document.querySelectorAll(".js-dropdown-title-box"),n=document.querySelectorAll(".js-list-dropdown"),r=document.querySelector(".js-search-category-title-box"),i=document.querySelector(".js-search-category-list");let t=null;[...e].forEach(o=>{o.addEventListener("click",s)});function s(o){let c=o.target.closest(".js-dropdown-title-box");t=c.firstElementChild,c.nextElementSibling.classList.contains("header__list-dropdown_active")?c.nextElementSibling.classList.remove("header__list-dropdown_active"):([...e].forEach(m=>{m.nextElementSibling.classList.remove("header__list-dropdown_active")}),c.nextElementSibling.classList.add("header__list-dropdown_active")),a(o,t)}[...n].forEach(o=>{o.addEventListener("click",c=>a(c,t))});function a(o,c){o.target.tagName==="LI"&&(c.textContent=o.target.textContent,[...e].forEach(m=>{m.nextElementSibling.classList.remove("header__list-dropdown_active")}))}r.addEventListener("click",l);function l(o){i.classList.toggle("search-category__list_active"),r.firstElementChild.classList.toggle("search-category__arrow-icon_active")}i.addEventListener("click",d);function d(o){o.target.tagName==="LI"&&(r.lastElementChild.textContent=o.target.textContent,l())}}function O(){const e=document.querySelector(".js-mob-menu"),n=document.querySelector(".js-burger-btn"),r=document.querySelector(".js-mob-menu-btn-close"),i=document.querySelector(".js-backdrop"),t=document.querySelector(".js-choose-city"),s=document.querySelector(".js-city-selection-list"),a=document.querySelector(".js-active-city"),l=document.querySelector(".js-information-item"),d=document.querySelector(".js-information-sub-list"),o=document.querySelector(".js-categories-item"),c=document.querySelector(".js-menu-categories-btn-close"),m=document.querySelector(".js-menu-categories"),_=document.querySelectorAll(".js-categories-list-title-box"),x=document.querySelector(".js-menu-categories-list"),E=document.querySelectorAll(".js-categories-sub-list");n.addEventListener("click",b),r.addEventListener("click",b),i.addEventListener("click",C);function b(u){e.classList.toggle("mob-menu--visible"),i.classList.toggle("backdrop--visible"),document.body.classList.toggle("to-freeze")}function C(u){b(),m.classList.remove("menu-categories--visible")}o.addEventListener("click",h),c.addEventListener("click",h);function h(u){m.classList.toggle("menu-categories--visible")}t.addEventListener("click",w);function w(u){if(!t.classList.contains("user-panel__city-selection-title_active")){s.style.maxHeight=s.scrollHeight+"px",t.classList.add("user-panel__city-selection-title_active");return}s.style.maxHeight=0,t.classList.remove("user-panel__city-selection-title_active")}s.addEventListener("click",j);function j(u){a.textContent=u.target.textContent,w()}l.addEventListener("click",q);function q(u){if(!l.classList.contains("nav-list-item__title-wrapper_active")){d.style.maxHeight=d.scrollHeight+"px",l.classList.add("nav-list-item__title-wrapper_active");return}d.style.maxHeight=0,l.classList.remove("nav-list-item__title-wrapper_active")}x.addEventListener("click",$);function $(u){const{target:v}=u;let p=v.closest(".js-categories-list-title-box");if(p){if(!p.classList.contains("menu-categories__list-title-box_active")){[..._].forEach(y=>{y.nextElementSibling.style.maxHeight=0,y.classList.remove("menu-categories__list-title-box_active")}),p.nextElementSibling.style.maxHeight=p.nextElementSibling.scrollHeight+"px",p.classList.add("menu-categories__list-title-box_active");return}p.nextElementSibling.style.maxHeight=0,p.classList.remove("menu-categories__list-title-box_active")}}E.forEach(u=>{u.addEventListener("click",P)});function P(u){const{target:v}=u;v.tagName==="LI"&&v.classList.toggle("menu-categories__sub-list-item_active")}}f.use([B,I,H,M]);function z(){return new f(".mainHeroSwiper",{autoplay:{delay:2e3,disableOnInteraction:!0},pagination:{el:".swiper-pagination"},speed:600})}function V(){const e=new f(".stock-swiper",{slidesPerView:"auto",spaceBetween:9,grid:{rows:2,fill:"row"},pagination:{el:".swiper-pagination"},navigation:{nextEl:".stock__swiper-button-next",prevEl:".stock__swiper-button-prev"}});g(e),window.addEventListener("resize",()=>g(e))}function N(){const e=new f(".seasona-swiper",{slidesPerView:"auto",spaceBetween:9,grid:{rows:2,fill:"row"},pagination:{el:".swiper-pagination"},navigation:{nextEl:".seasona__swiper-button-next",prevEl:".seasona__swiper-button-prev"}});g(e),window.addEventListener("resize",()=>g(e))}function T(){const e=new f(".present-swiper",{slidesPerView:"auto",spaceBetween:9,grid:{rows:2,fill:"row"},pagination:{el:".swiper-pagination"},navigation:{nextEl:".present__swiper-button-next",prevEl:".present__swiper-button-prev"}});g(e),window.addEventListener("resize",()=>g(e))}function D(){return new f(".forum-swiper",{slidesPerView:"auto",spaceBetween:20,pagination:{el:".swiper-pagination"},speed:600})}function g(e){window.innerWidth<=425?(e.params.slidesPerView=2,e.params.spaceBetween=9):window.innerWidth>=1024?(e.params.spaceBetween=20,e.params.slidesPerView=4):e.params.slidesPerView="auto",e.update()}function W(e,n){const r=e.map(({discount:i,price:t,img:{png:s,webp:a},title:l})=>`
          ...
          </div>`);n.innerHTML=r.join("")}function K(e){const n=document.querySelector(".js-main-swiper-stock"),r=document.querySelector(".js-main-swiper-seasonal"),i=document.querySelector(".js-main-swiper-present"),t=["Stock","Seasonal","Present"],s=[n,r,i],a=L(e);async function l(d="",o=""){try{const c=await k(S(a,d)),m=[];c.forEach(_=>{m.push({id:_.id,..._.data()})}),W(m,o)}catch(c){return console.error("Error getting documents:",c),[]}}for(let d=0;d<t.length;d++){const o=t[d],c=s[d];l(o,c)}}function G(){const e=document.querySelector(".js-preloader");n();function n(){if(!localStorage.getItem("is-visit")){r();return}e.classList.add("preloader_hidden"),document.body.classList.remove("to-freeze")}function r(){e.classList.add("preloader_visible"),document.body.classList.add("to-freeze"),setTimeout(()=>{e.classList.add("preloader_hidden"),document.body.classList.remove("to-freeze"),localStorage.setItem("is-visit","true")},4e3)}}function Q(){return A({apiKey:"AIzaSyCeoo8r7oEqKQs1O_YxVO2RAd8WWV3HWso",authDomain:"flowers-4b1a5.firebaseapp.com",projectId:"flowers-4b1a5",storageBucket:"flowers-4b1a5.appspot.com",messagingSenderId:"719757325067",appId:"1:719757325067:web:6e609ba7f0d37bdd23e80e"})}function R(e){const n=document.querySelector(".js-main-swiper-forum"),r=e.map(({title:i,description:t,img:{png:s,webp:a}})=>`
      <div class="swiper-slide">
          ...
          </div>`);n.innerHTML=r.join("")}function Y(e){const n=L(e);async function r(){try{const i=await k(S(n,"main-forum")),t=[];i.forEach(s=>{t.push({id:s.id,...s.data()})}),R(t)}catch(i){return console.error("Error getting documents:",i),[]}}r()}document.addEventListener("DOMContentLoaded",()=>{let e=Q();F(),O(),z(),K(e),V(),G(),N(),T(),D(),Y(e)});
